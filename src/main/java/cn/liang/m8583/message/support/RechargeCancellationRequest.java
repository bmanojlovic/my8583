 ...
 * 2012-3-20
 */
public class RechargeCancellationRequest extends Request{

	public RechargeCancellationRequest(MessageType mt) {
		super(mt);
	...
	public boolean equals(Object obj) {
		if (!super.equals(obj)||!(obj instanceof RechargeCancellationRequest)) {
			return false;
		}
		RechargeCancellationRequest rcr = (RechargeCancellationRequest) obj;
		return  rcr.getCard().equals(card)
				&& rcr.getAmount() == amount
				&& rcr.getRetrievalReferenceNumber().equals(rrn)
				&& Arrays.equals(rcr.getPin(), pin);
